# Prompts de imagen · Antes de automatizar, mide la fuga
...
Los PNG van a `outputs/2026-07-20_antes-de-automatizar-mide-la-fuga/final/` con el nombre indicado.

## Slide 1 · hook → `final/slide-01.png`

```
PORTADA (hook) -- slide 1/7 de "Antes de automatizar, mide la fuga"
...
TITULAR (texto exacto a renderizar en la imagen): "ANTES DE AUTOMATIZAR, MIDE LA FUGA"
APOYO (texto exacto, más pequeño): "La IA no arregla un negocio desordenado. Lo acelera."
...
```
SLIDE INTERIOR -- slide 2/7 de "Antes de automatizar, mide la fuga"
...
TITULAR (texto exacto a renderizar en la imagen): "EL ORDEN VA ANTES QUE EL ROBOT"
APOYO (texto exacto, más pequeño): "Automatizar el caos solo lo hace más rápido."
...
```
SLIDE INTERIOR -- slide 3/7 de "Antes de automatizar, mide la fuga"
...
TITULAR (texto exacto a renderizar en la imagen): "ESAS 200 HORAS EQUIVALEN A UNOS 3.000€ AL AÑO POR AUTÓNOMO"
...
RESALTADO DE MARCA (obligatorio, sin excepción): pinta en naranja #FF4B0B únicamente el fragmento "200 HORAS" dentro del titular o del apoyo, tal y como aparece en el texto. El resto del texto va en tinta negra #090909. No resaltes ninguna otra palabra ni cifra, y no dejes el titular completo en un solo color.
...
- Cifra exacta a mostrar en grande dentro de la tarjeta del medidor: "200 horas".
- Un solo concepto visual que explique la idea en menos de 2 segundos. Espacio negativo generoso alrededor de la escena.
...
```
SLIDE INTERIOR -- slide 4/7 de "Antes de automatizar, mide la fuga"
...
TITULAR (texto exacto a renderizar en la imagen): "EL MÉTODO CABE EN UNA NOTA"
APOYO (texto exacto, más pequeño): "Siete días apuntando. Nada más."
...
- Textos exactos de los ítems, uno por tarjeta y en este orden: "Apunta cada tarea repetida", "Suma el tiempo real", "Marca lo que puede funcionar solo".
- Un solo concepto visual que explique la idea en menos de 2 segundos. Espacio negativo generoso alrededor de la escena.
...
```
SLIDE INTERIOR -- slide 5/7 de "Antes de automatizar, mide la fuga"
...
TITULAR (texto exacto a renderizar en la imagen): "AUTOMATIZA LO REPETIBLE"
APOYO (texto exacto, más pequeño): "Lo que necesita criterio se queda contigo."
...
## Slide 6 · synthesis → `final/slide-06.png`

```
SLIDE INTERIOR -- slide 6/7 de "Antes de automatizar, mide la fuga"
...
## Slide 7 · cta → `final/slide-07.png`

```
CIERRE (CTA) -- slide 7/7 de "Antes de automatizar, mide la fuga"
...
TITULAR (texto exacto a renderizar en la imagen): "COMENTA CÁLCULO"
APOYO (texto exacto, más pequeño): "Te envío la hoja."
ETIQUETA SUPERIOR del chip (adaptativa -- nunca "DATO 01" fijo): "TU TURNO"
RESALTADO DE MARCA (obligatorio, sin excepción): pinta en naranja #FF4B0B únicamente el fragmento "Comenta CÁLCULO" dentro del titular o del apoyo, tal y como aparece en el texto. El resto del texto va en tinta negra #090909. No resaltes ninguna otra palabra ni cifra, y no dejes el titular completo en un solo color.
...
- Acción exacta a mostrar en el botón pill: "Comenta CÁLCULO".
- Si el CTA es de palabra clave, mostrar literalmente "CÁLCULO" en mayúsculas y qué recibe la persona.
