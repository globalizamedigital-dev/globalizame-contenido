...
```
PORTADA (hook) -- slide 1/6 de "Solo 1 de cada 8 negocios pequeños usa IA"
...
TITULAR (texto exacto a renderizar en la imagen): "SOLO 1 DE CADA 8 NEGOCIOS PEQUEÑOS USA IA"
APOYO (texto exacto, más pequeño): "El negocio pequeño es justo el que menos la aprovecha."
ETIQUETA SUPERIOR del chip (adaptativa -- nunca "DATO 01" fijo): "DATO CLAVE"
RESALTADO DE MARCA (obligatorio, sin excepción): pinta en naranja #FF4B0B únicamente el fragmento "1 DE CADA 8" dentro del titular o del apoyo, tal y como aparece en el texto. El resto del texto va en tinta negra #090909. No resaltes ninguna otra palabra ni cifra, y no dejes el titular completo en un solo color.
...
```
SLIDE INTERIOR -- slide 2/6 de "Solo 1 de cada 8 negocios pequeños usa IA"
...
TITULAR (texto exacto a renderizar en la imagen): "PARECE PEQUEÑO HASTA QUE LO SUMAS"
APOYO (texto exacto, más pequeño): "Los minutos sueltos terminan ocupando días."
...
```
SLIDE INTERIOR -- slide 3/6 de "Solo 1 de cada 8 negocios pequeños usa IA"
...
```
SLIDE INTERIOR -- slide 4/6 de "Solo 1 de cada 8 negocios pequeños usa IA"
...
TITULAR (texto exacto a renderizar en la imagen): "EL COSTE NO LLEGA EN UNA FACTURA"
APOYO (texto exacto, más pequeño): "Aparece como retrasos, errores y trabajo importante que nunca empieza."
...
```
SLIDE INTERIOR -- slide 5/6 de "Solo 1 de cada 8 negocios pequeños usa IA"
...
TITULAR (texto exacto a renderizar en la imagen): "MIRA DÓNDE SE REPITE"
APOYO (texto exacto, más pequeño): "Una semana basta para dejar de decidir por intuición."
...
- Textos exactos de los ítems, uno por tarjeta y en este orden: "Tareas que vuelven", "Interrupciones constantes", "Oportunidades sin respuesta".
- Un solo concepto visual que explique la idea en menos de 2 segundos. Espacio negativo generoso alrededor de la escena.
...
```
CIERRE (CTA) -- slide 6/6 de "Solo 1 de cada 8 negocios pequeños usa IA"
...
TITULAR (texto exacto a renderizar en la imagen): "¿DÓNDE SE TE VA EL TIEMPO?"
APOYO (texto exacto, más pequeño): "Cuéntamelo en comentarios."
...
- Escena concreta: El robot de marca se dirige al lector con postura abierta y ofrece un bocadillo de diálogo 3D blanco con tres puntos naranjas de 'escribiendo…'. Invita a responder, no decora. Debajo, un botón pill naranja con la acción exacta.
...
- Acción exacta a mostrar en el botón pill: "Responde en comentarios".
