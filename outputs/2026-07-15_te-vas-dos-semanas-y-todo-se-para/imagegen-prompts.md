# Prompts de imagen · Te vas dos semanas y todo se para
...
Los PNG van a `outputs/2026-07-15_te-vas-dos-semanas-y-todo-se-para/final/` con el nombre indicado.

## Slide 1 · hook → `final/slide-01.png`

```
PORTADA (hook) -- slide 1/6 de "Te vas dos semanas y todo se para"
...
TITULAR (texto exacto a renderizar en la imagen): "TE VAS DOS SEMANAS Y TODO SE PARA"
APOYO (texto exacto, más pequeño): "Un negocio que depende de ti no descansa ni en vacaciones."
ETIQUETA SUPERIOR del chip (adaptativa -- nunca "DATO 01" fijo): "ERROR COMÚN"
...
- Dirección de escena concreta: Replica la composición de la portada de referencia: robot de marca angustiado a la derecha; bandeja 3D blanca de papeleo acumulado abajo a la izquierda; hojas y fichas de tiempo caen desde la bandeja hacia un sumidero naranja. Todo forma una sola escena narrativa, no un objeto gigante aislado.
...
```
SLIDE INTERIOR -- slide 2/6 de "Te vas dos semanas y todo se para"
...
TITULAR (texto exacto a renderizar en la imagen): "EL PROBLEMA NO GRITA. GOTEA"
APOYO (texto exacto, más pequeño): "Cada goteo pequeño acaba vaciando la semana."
...
```
SLIDE INTERIOR -- slide 3/6 de "Te vas dos semanas y todo se para"
...
```
SLIDE INTERIOR -- slide 4/6 de "Te vas dos semanas y todo se para"
...
TITULAR (texto exacto a renderizar en la imagen): "NADIE TE COBRA POR PERDER TIEMPO"
APOYO (texto exacto, más pequeño): "Por eso no lo apuntas. Y por eso sigue pasando."
ETIQUETA SUPERIOR del chip (adaptativa -- nunca "DATO 01" fijo): "EL COSTE"
RESALTADO DE MARCA (obligatorio, sin excepción): el titular y el apoyo van completos en tinta negra #090909, sin ningún fragmento en naranja. El naranja de esta slide vive en la escena 3D y el mobiliario de marca, no en el texto.
...
```
SLIDE INTERIOR -- slide 5/6 de "Te vas dos semanas y todo se para"
...
TITULAR (texto exacto a renderizar en la imagen): "SEÑALES DE QUE YA TE PASA"
APOYO (texto exacto, más pequeño): "Si marcas dos de tres, hay algo que ordenar."
ETIQUETA SUPERIOR del chip (adaptativa -- nunca "DATO 01" fijo): "DETECTA"
RESALTADO DE MARCA (obligatorio, sin excepción): el titular y el apoyo van completos en tinta negra #090909, sin ningún fragmento en naranja. El naranja de esta slide vive en la escena 3D y el mobiliario de marca, no en el texto.
...
- Textos exactos de los ítems, uno por tarjeta y en este orden: "Respondes lo mismo cada día", "Todo pasa por tu móvil", "El papeleo espera al finde".
- Un solo concepto visual que explique la idea en menos de 2 segundos. Espacio negativo generoso alrededor de la escena.
...
```
CIERRE (CTA) -- slide 6/6 de "Te vas dos semanas y todo se para"
...
TITULAR (texto exacto a renderizar en la imagen): "GUÁRDALO PARA MEDIRLO"
APOYO (texto exacto, más pequeño): "Vuelve con una semana de datos reales."
...
- Escena concreta: El robot de marca guarda esta pieza: sostiene una tarjeta 3D blanca (miniatura abstracta de este carrusel, sin texto legible) y la desliza dentro de un archivador blanco con pestaña-marcador naranja. Gesto satisfecho, guiño al lector. Debajo, un botón pill naranja con la acción exacta.
...
- Acción exacta a mostrar en el botón pill: "Guardar".
