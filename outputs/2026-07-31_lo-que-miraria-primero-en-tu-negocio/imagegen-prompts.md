# Prompts de imagen · Lo que miraría primero en tu negocio
...
Los PNG van a `outputs/2026-07-31_lo-que-miraria-primero-en-tu-negocio/final/` con el nombre indicado.

## Slide 1 · hook → `final/slide-01.png`

```
PORTADA (hook) -- slide 1/6 de "Lo que miraría primero en tu negocio"
...
TITULAR (texto exacto a renderizar en la imagen): "LO QUE MIRARÍA PRIMERO EN TU NEGOCIO"
APOYO (texto exacto, más pequeño): "El contraste entre depender de ti y funcionar sin ti."
...
- Dirección de escena concreta: Conserva exactamente la gramática de la portada de referencia: titular arriba a la izquierda, robot expresivo a la derecha y una escena 3D explicativa integrada en la parte inferior.
...
```
SLIDE INTERIOR -- slide 2/6 de "Lo que miraría primero en tu negocio"
...
TITULAR (texto exacto a renderizar en la imagen): "NO DECIDIR YA ES UNA DECISIÓN"
APOYO (texto exacto, más pequeño): "Y también se paga, aunque no llegue factura."
...
```
SLIDE INTERIOR -- slide 3/6 de "Lo que miraría primero en tu negocio"
...
TITULAR (texto exacto a renderizar en la imagen): "ENTRE LAS MICROEMPRESAS EL USO DE IA SUBE AL 13,4%"
APOYO (texto exacto, más pequeño): "El dato existe. Falta compararlo con tu semana."
ETIQUETA SUPERIOR del chip (adaptativa -- nunca "DATO 01" fijo): "DATO CLAVE"
RESALTADO DE MARCA (obligatorio, sin excepción): pinta en naranja #FF4B0B únicamente el fragmento "13,4%" dentro del titular o del apoyo, tal y como aparece en el texto. El resto del texto va en tinta negra #090909. No resaltes ninguna otra palabra ni cifra, y no dejes el titular completo en un solo color.
...
- Cifra exacta a mostrar en grande dentro de la tarjeta del medidor: "13,4%".
- Un solo concepto visual que explique la idea en menos de 2 segundos. Espacio negativo generoso alrededor de la escena.
...
```
SLIDE INTERIOR -- slide 4/6 de "Lo que miraría primero en tu negocio"
...
TITULAR (texto exacto a renderizar en la imagen): "QUÉ MIRARÍA EN TU CASO"
APOYO (texto exacto, más pequeño): "Media hora da para esto."
ETIQUETA SUPERIOR del chip (adaptativa -- nunca "DATO 01" fijo): "DECISIÓN"
RESALTADO DE MARCA (obligatorio, sin excepción): el titular y el apoyo van completos en tinta negra #090909, sin ningún fragmento en naranja. El naranja de esta slide vive en la escena 3D y el mobiliario de marca, no en el texto.
...
- Textos exactos de los ítems, uno por tarjeta y en este orden: "Dónde pierdes tiempo", "Qué se puede ordenar ya", "Qué no toca automatizar".
- Un solo concepto visual que explique la idea en menos de 2 segundos. Espacio negativo generoso alrededor de la escena.
...
```
SLIDE INTERIOR -- slide 5/6 de "Lo que miraría primero en tu negocio"
...
TITULAR (texto exacto a renderizar en la imagen): "PRIMERO NÚMEROS. LUEGO DECISIÓN"
APOYO (texto exacto, más pequeño): "Con los datos delante, elegir es fácil."
...
```
CIERRE (CTA) -- slide 6/6 de "Lo que miraría primero en tu negocio"
