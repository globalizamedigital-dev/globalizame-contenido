...
```
PORTADA del carrusel "Lo que miraría primero en tu negocio".
...
- Conserva exactamente la gramática de la portada de referencia: titular arriba a la izquierda, robot expresivo a la derecha y una escena 3D explicativa integrada en la parte inferior.
...
```
SLIDE INTERIOR del carrusel "Lo que miraría primero en tu negocio".
...
```
CIERRE del carrusel "Lo que miraría primero en tu negocio".
