# Prompts de imagen · Las 200 horas que un autónomo pierde al año
...
Los PNG van a `outputs/2026-07-22_las-200-horas-que-un-autonomo-pierde-al-ano/final/` con el nombre indicado.

## Slide 1 · hook → `final/slide-01.png`

```
PORTADA del carrusel "Las 200 horas que un autónomo pierde al año".
...
TITULAR: "LAS 200 HORAS QUE UN AUTÓNOMO PIERDE AL AÑO"
APOYO, debajo del titular en texto más pequeño: "Cuatro horas cada semana solo en papeleo. Sin facturar nada."
ETIQUETA SUPERIOR del chip: "MIRA ESTO"
RESALTADO DE MARCA: pinta en naranja #FF4B0B únicamente el fragmento "200" dentro del titular o del apoyo, tal y como aparece en el texto. El resto del texto va en tinta negra #090909. No resaltes ninguna otra palabra ni cifra, y no dejes el titular completo en un solo color.
...
- Replica la composición de la portada de referencia: robot de marca angustiado a la derecha; bandeja 3D blanca de papeleo acumulado abajo a la izquierda; hojas y fichas de tiempo caen desde la bandeja hacia un sumidero naranja. Todo forma una sola escena narrativa, no un objeto gigante aislado.
...
```
SLIDE INTERIOR del carrusel "Las 200 horas que un autónomo pierde al año".
...
APOYO, debajo del titular en texto más pequeño: "Sin proceso claro, la herramienta estorba."
...
TITULAR: "UN AUTÓNOMO DEDICA DE MEDIA 200 HORAS AL AÑO"
APOYO, debajo del titular en texto más pequeño: "Pon esta cifra al lado de tu agenda real."
ETIQUETA SUPERIOR del chip: "DATO CLAVE"
RESALTADO DE MARCA: pinta en naranja #FF4B0B únicamente el fragmento "200 HORAS" dentro del titular o del apoyo, tal y como aparece en el texto. El resto del texto va en tinta negra #090909. No resaltes ninguna otra palabra ni cifra, y no dejes el titular completo en un solo color.
...
APOYO, debajo del titular en texto más pequeño: "Respóndelas con datos, no de memoria."
...
APOYO, debajo del titular en texto más pequeño: "Si el proceso no está claro, ningún robot lo arregla."
...
```
CIERRE del carrusel "Las 200 horas que un autónomo pierde al año".
...
TITULAR: "COMENTA CÁLCULO"
APOYO, debajo del titular en texto más pequeño: "Te envío la hoja."
ETIQUETA SUPERIOR del chip: "TU TURNO"
RESALTADO DE MARCA: pinta en naranja #FF4B0B únicamente el fragmento "Comenta CÁLCULO" dentro del titular o del apoyo, tal y como aparece en el texto. El resto del texto va en tinta negra #090909. No resaltes ninguna otra palabra ni cifra, y no dejes el titular completo en un solo color.
...
- Texto exacto del botón pill: "Comenta CÁLCULO".
- Muestra literalmente "CÁLCULO" en mayúsculas y qué recibe la persona.
